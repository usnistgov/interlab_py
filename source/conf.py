...
# -*- coding: utf-8 -*-
#
# interlab documentation build configuration file, created by
...
def setup(app):
    ...
    # Google analytics
    app.add_javascript(
        "https://dap.digitalgov.gov/Universal-Federated-Analytics-Min.js?agency=NIST&subagency=github&pua=UA-42404149-54&yt=true&exts=ppsx,pps,f90,sch,rtf,wrl,txz,m1v,xlsm,msi,xsd,f,tif,eps,mpg,xml,pl,xlt,c",
        id="_fed_an_ua_tag",
    )
...
latex_documents = [
    (master_doc, "interlab.tex", "interlab Documentation", "David A. Sheen", "manual"),
]
...
man_pages = [(master_doc, "interlab", "interlab Documentation", [author], 1)]
