...
latex_documents = [
    (master_doc, 'interlab.tex', 'interlab Documentation',
     'David A. Sheen', 'manual'),
]
...
man_pages = [
    (master_doc, 'interlab', 'interlab Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'interlab', 'interlab Documentation',
     author, 'interlab', 'One line description of project.',
     'Miscellaneous'),
]
