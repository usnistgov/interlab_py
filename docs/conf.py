...
sys.path.insert(0, str(Path("../examples/usage").resolve()))
...
napoleon_type_aliases = {
    ...
    "Axis": ":py:class:`~matplotlib.axis.Axis`",
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/interlab_py",
...
htmlhelp_basename = "interlab_pydoc"
